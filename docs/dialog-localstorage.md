...
Files are now gzipped before being base32768 encoded.

The Dialog library accepts a prefix ID, to allow multiple file systems to coexist, even at different versions. This is most useful for a service like Itch where everyone's games are hosted on the one subdomain. [See forum discussion.](https://intfiction.org/t/parchment-error-on-itch-error-dialog-storage-version-is-newer-than-this-library-supports/81332)